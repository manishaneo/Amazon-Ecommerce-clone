...
export const login = asyncHandler(async (req, res) => {
  ...
  try {
    console.log("Calling GG-Life backend from Amazon...");
    const gglifeResponse = await axios.post(
    ...
    console.log("GG-Life Response:", gglifeResponse.data);

  } catch (error) {
    console.error("GG-Life service error:", error.message);
  }
